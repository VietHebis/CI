...
<div id='slide'>
	<div id="img-slide" class="sliderContainer" style='width:580px'>
		<div id="HomeSlide" class="royalSlider rsMinW">
                            <?php foreach ($this->data['slide'] as $row):?>
		      		      <a href="<?php echo $row->link?>" target='_blank'><img src="<?php echo base_url();?>upload/slide/<?php echo $row->image_link?>" alt="<?php echo $row->name?>" /> </a>
                            <?php endforeach;?>
		      		</div>
	</div>
	<div class="clear"></div>
