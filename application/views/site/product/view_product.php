<!-- video -->
<script type='text/javascript' src='<?php echo base_url('assets')?>/site/tivi/jwplayer.js'></script>
<script type='text/javascript'>
    jQuery('document').ready(function(){
        jwplayer('mediaspace').setup({
            'flashplayer': '<?php echo base_url('assets')?>/site/tivi/player.swf',
...
<!-- zoom image -->
<script src="<?php echo base_url('assets/site')?>/jqzoom_ev/js/jquery.jqzoom-core.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php echo base_url('assets/site')?>/jqzoom_ev/css/jquery.jqzoom.css" type="text/css">
<script type="text/javascript">
    $(document).ready(function() {
        $('.jqzoom').jqzoom({
            zoomType: 'standard',
    ...
    <div class="box-content-center product"><!-- The box-content-center -->
        <div class='product_view_img'>
            <a href="<?php echo base_url('upload/product/'.$product->image_link)?>" class="jqzoom" rel='gal1'  title="triumph" >
                <img  src="<?php echo base_url('upload/product/'.$product->image_link)?>" alt='<?php echo $product->name?>' style="width:280px !important">
            </a>
        ...
        <div class='product_view_content'>
            ...
            <p class='option'>
                ...
                <?php $price_new = $product->price - $product->discount?>
                    ...
                    <span class='product_price'><?php echo number_format($price_new)?></span>
                <?php else:?>
                    Giá: <span class='product_price'><?php echo number_format($product->price)?></span>
                <?php endif;?>
            </p>

            <p class='option'>
                Danh mục:
                <a href="" title="<?php echo $catalog->name?>">
            ...
            <?php if (isset($product->warranty)):?>
            <p class='option'>
                Bảo hành: <b><?php echo $product->warranty?></b>
            </p>
            <?php endif;?>
            <?php if (isset($product->gifts)):?>
            <p class='option'>
...
<div class="usual-content">
    <div id="tab2" style="display: block;">
        <p>B&agrave;i viết cho sản phẩm n&agrave;y đang được cập nhật ...</p>
        <!-- comment facebook -->
        <center>
            <div id="fb-root"></div>
    ...
    <div id="tab4" style="display: none;">
        <div class='box-show-product'>
            ...
            <div class="comments">
                <div class="title"><h3>THẢO LUẬN CỦA KHÁCH HÀNG <span class="yellow">(0)</span></h3><h4>Ý kiến khách hàng về Sản phẩm <?php echo $product->name?></h4></div>
                <br class="break">
                <div class="reviews">
