...
$(function() {
    $( "#text-search" ).autocomplete({
        source: "<?php echo base_url('product/autocomplete')?>",
    });
});
</script>
<div class="top"><!-- The top -->
    ...
    <div class="clear"></div><!-- clear float --> 
           ...
           <ul class="menu_top">
                ...
                <li class=""><a href="<?php echo base_url('user/contact')?>">Liên hệ</a></li>
               <?php if (isset($info)):?>
                   <li class=""><a href="<?php echo base_url('user')?>" >Xin chào <?php echo $info->name?></a></li>
